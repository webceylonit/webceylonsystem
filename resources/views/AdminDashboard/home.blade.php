...
<div class="container-fluid">
  <div class="row widget-grid">
    ...
    @permission('Admin Dashboard Details')
          ...
          <div class="card widget-1">
            <div class="card-body">
              <div class="widget-content">
                ...
                <div>
                  <h4>{{ $assignedProjectsCount }}</h4><span class="f-light">Assigned Projects</span>
                </div>
              </div>
                ...
                <div class="widget-content">
                  <div class="widget-round secondary">
                    <div class="bg-round">
                      ...
                      <svg class="svg-fill">
                        <use href="frontend/assets/svg/icon-sprite.svg#clock"> </use>
                      </svg>
                    </div>
                  </div>
                  <div>
                  <h4>{{ $dueTodayCount }}</h4><span class="f-light">Tasks Due Today</span>
                  </div>
                </div>
          ...
          <div class="card widget-1">
            <div class="card-body">
              <div class="widget-content">
                ...
                <div>
                  <h4>{{ $devOngoing }}</h4><span class="f-light">Ongoing Projects</span>
          ...
          <div class="card widget-1">
            <div class="card-body">
              <div class="widget-content">
                ...
                <div>
                <h4>{{ $devCompleted }}</h4><span class="f-light">Completed Projects</span>
                </div>
              </div>
