  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex flex-wrap align-items-center">
        ...
        <a href="{{ route('sprints.index', ['project_id' => $project->id]) }}" class="btn btn-secondary btn-sm ms-1">Sprints</a>
        <a href="{{ route('projects.edit', $project->id) }}" class="btn btn-warning btn-sm ms-1">Edit</a>
        <form action="{{ route('projects.destroy', $project->id) }}" method="POST" class="ms-1" onsubmit="return confirm('Are you sure you want to delete this project?');">
          @csrf
          @method('DELETE')
          <button type="submit" class="btn btn-danger btn-sm">Delete</button>
        </form>
        <a href="{{ route('projects.tableView') }}" class="btn btn-dark btn-sm ms-1">Back to List</a>
      </div>
    </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>${{ number_format($project->estimate_budget, 2) }}</td>
          </tr>
          <tr>
            <th>Start Date</th>
