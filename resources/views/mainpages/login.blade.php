...
<html lang="en">
  <head>
    ...
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/vendors/icofont.css">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/vendors/themify.css">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/vendors/flag-icon.css">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/vendors/feather-icon.css">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/vendors/sweetalert2.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/vendors/bootstrap.css">
    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="frontend/assets/css/style.css">
    <link id="color" rel="stylesheet" href="frontend/assets/css/color-1.css" media="screen">
    <!-- Responsive css-->
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 p-0">
          <div class="login-card login-dark">
            <div>
              <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light" src="frontend/assets/images/logo/logo.png" alt="looginpage"><img class="img-fluid for-dark" src="frontend/assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
      ...
      <!-- Plugins JS start-->
      <script src="frontend/assets/js/sweet-alert/sweetalert.min.js"></script>
      <!-- Plugins JS Ends-->
      <!-- Theme js-->
